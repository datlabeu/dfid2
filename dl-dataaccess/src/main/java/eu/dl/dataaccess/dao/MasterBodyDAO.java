...
public interface MasterBodyDAO<T extends MasterBody> extends MasterDAO<T> {
    ...
    /**
     * Same as {@link MasterBodyDAO#getModifiedAfter(LocalDateTime, Integer, Integer)} but uses default page size.
     *
     * @param timestamp
     *            objects modified after this timestamp will be returned
     * @param page
    ...
    /**
     * Same as {@link MasterBodyDAO#getModifiedAfter(LocalDateTime, String, Integer, Integer)} but uses default page size.
     *
     * @param timestamp
     *            objects modified after this timestamp will be returned
     * @param modifiedBy
