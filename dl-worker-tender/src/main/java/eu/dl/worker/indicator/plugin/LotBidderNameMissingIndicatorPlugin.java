 ...
 * Missing bidder name.
 */
public class LotBidderNameMissingIndicatorPlugin extends BaseLotIndicatorPlugin {
    @Override
    public final Indicator evaluate(final MasterTenderLot masterLot, final MasterTender tender) {
        ...
        for(MasterBody bidder: winningBid.getBidders()) {
            if(bidder.getName() == null || bidder.getName().isEmpty()) {
    ...
    public final String getType() {
        return TenderIndicatorType.TRANSPARENCY_BIDDER_NAME_MISSING.name();
    }
}
